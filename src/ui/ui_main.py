...
class Ui_Sho(object):
    def setupUi(self, Sho):
        ...
        self.current_filename = QtWidgets.QLabel(self.topBar)
        self.current_filename.setText("")
        self.current_filename.setObjectName("current_filename")
        self.horizontalLayout_2.addWidget(self.current_filename)
        ...
        self.btn_search = QtWidgets.QToolButton(self.topBar)
    ...
    def retranslateUi(self, Sho):
        ...
        self.edited_file.setToolTip(_translate("Sho", "filename of the note being edited"))
        self.folder_path.setToolTip(_translate("Sho", "Current branch of folder tree"))
        self.file_count.setToolTip(_translate("Sho", "Files in file list"))
