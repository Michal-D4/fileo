...
class notesContainer(QScrollArea):
    ...
    def found_next_note(self) -> bool:
        beg = self.ids.index(fileNote.current_note.note_id)+1 if fileNote.current_note else 0
