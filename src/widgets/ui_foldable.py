...
class Ui_foldable(object):
    def setupUi(self, foldable):
        ...
        self.fold_head.setMinimumSize(QtCore.QSize(0, 26))
        self.fold_head.setMaximumSize(QtCore.QSize(16777215, 26))
        ...
        self.toFold.setMinimumSize(QtCore.QSize(0, 23))
        self.toFold.setMaximumSize(QtCore.QSize(16777215, 23))
        self.toFold.setToolTip("")
        self.toFold.setToolTipDuration(-1)
        self.toFold.setStyleSheet("")
        self.toFold.setText("")
        self.toFold.setIconSize(QtCore.QSize(20, 20))
