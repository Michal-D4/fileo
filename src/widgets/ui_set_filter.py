...
class Ui_filterSetup(object):
    def setupUi(self, filterSetup):
        ...
        self.rating_frame = QtWidgets.QFrame(parent=self.form)
        self.rating_frame.setObjectName("rating_frame")
        self.HLayoutRating = QtWidgets.QHBoxLayout(self.rating_frame)
        self.HLayoutRating.setContentsMargins(1, -1, -1, -1)
        self.HLayoutRating.setObjectName("HLayoutRating")
        self.rating_cond = QtWidgets.QComboBox(parent=self.rating_frame)
        self.rating_cond.setObjectName("rating_cond")
        self.rating_cond.addItem("")
        self.rating_cond.addItem("")
        self.rating_cond.addItem("")
        self.HLayoutRating.addWidget(self.rating_cond)
        spacerItem4 = QtWidgets.QSpacerItem(12, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.HLayoutRating.addItem(spacerItem4)
        self.rating_edit = QtWidgets.QLineEdit(parent=self.rating_frame)
        ...
        self.HLayoutRating.addItem(spacerItem5)
        self.HLayoutRating.setStretch(0, 1)
        self.HLayoutRating.setStretch(2, 2)
        self.HLayoutRating.setStretch(3, 1)
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.ItemRole.FieldRole, self.rating_frame)
