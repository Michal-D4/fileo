...
class Ui_aboutForm(object):
    def setupUi(self, aboutForm):
        ...
        aboutForm.resize(457, 207)
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(aboutForm)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.frame_about = QtWidgets.QFrame(parent=aboutForm)
        ...
        self.ttl_frame = QtWidgets.QFrame(parent=self.frame_about)
        ...
        self.ico.setMinimumSize(QtCore.QSize(32, 32))
        ...
        self.fr_about = QtWidgets.QFrame(parent=self.frame_about)
        ...
        self.fr_btn = QtWidgets.QFrame(parent=self.frame_about)
